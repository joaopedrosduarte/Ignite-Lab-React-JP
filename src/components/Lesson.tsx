...
export function Lesson(props : LessonsProps){
        ...
        const DateFormatted = format(props.availableAt, "EEEE' • 'd' de 'MMMM' • 'k'h'mm", {locale: ptBR})
        ...
        return(
                isLessonAvaiable ? (
                        <Link to={`/event/lesson/${props.slug}`} className='group'> 
                                ...
                                <div className={`border-gray-500 border rounded p-4 mt-2 group-hover:border-green-500 transition-colors ${isActiveLesson ? ('bg-green-500 border-green-500') : ''}`}>
                                        <header className="flex itens-center justify-between">
                                                ...
                                                ) : ( //text-blue-500 text-sm font-medium flex itens-center gap-2
                                                        <span className='text-sm font-medium flex items-center gap-2 text-orange-500'>
                                                                <Lock size={20} />
                                                                Em breve
                                                        </span>
                                                )}
                                                <span className={classNames("text-white rounded border border-green-300 px-2 py-[2px] text-xs", {
